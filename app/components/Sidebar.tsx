  ...
  return (
    <aside className="w-64 border-r border-zinc-800 bg-zinc-900 flex flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto px-4 pb-4 space-y-8 custom-scrollbar">
        <div>
          <h3 className="px-3 text-[10px] uppercase tracking-[0.2em] text-zinc-300 font-bold mb-3">
      ...
      <div className="p-4 bg-zinc-900/30 border-t border-zinc-800">
        <div className="flex items-center gap-3">
          <Link
            ...
            target="_blank"
            className="flex items-center gap-3 px-3 py-2 text-sm text-zinc-300 hover:text-zinc-300 transition-colors"
          >
